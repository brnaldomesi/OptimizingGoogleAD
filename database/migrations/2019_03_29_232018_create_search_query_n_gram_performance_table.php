...
class CreateSearchQueryNGramPerformanceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('search_query_n_gram_performance', function (Blueprint $table) {
            $table->uuid('id');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('search_query_n_gram_performance');
    }
}
