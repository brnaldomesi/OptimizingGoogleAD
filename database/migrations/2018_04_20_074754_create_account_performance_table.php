...
class CreateAccountPerformanceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('account_performance', function (Blueprint $table) {
            $table->uuid('id');
            $table->timestamps();
    ...
    public function down()
    {
        Schema::table('account_performance', function (Blueprint $table) {
            Schema::dropIfExists('account_performance');
        });
    }
}
