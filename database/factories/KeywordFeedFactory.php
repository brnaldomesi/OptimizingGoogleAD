...
$factory->define(App\Models\KeywordFeed::class, function (Faker $faker) {
    return [
        ...
        'suggestion'		=>	$faker->randomElement(['Sort your shit out!', 'We recommend increasing spend in this area']),
