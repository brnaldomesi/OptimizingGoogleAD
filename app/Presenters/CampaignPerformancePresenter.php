...
class CampaignPerformancePresenter extends Presenter
{
    public function cost()
    {
        ...
        return Money::{$this->model->campaign->account->currency_code}($this->model->cost * 100);
    }
    ...
    public function averageCpc()
    {
        ...
        return Money::{$this->model->campaign->account->currency_code}($this->model->average_cpc * 100);
    }
    ...
    public function conversionValue()
    {
        ...
        return Money::{$this->model->campaign->account->currency_code}($this->model->conversion_value * 100);
    }
    ...
    public function cpa()
    {
        ...
        return Money::{$this->model->campaign->account->currency_code}($this->model->cpa * 100);
    }
